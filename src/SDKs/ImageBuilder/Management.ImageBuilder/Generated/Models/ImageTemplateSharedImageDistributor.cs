...
namespace Microsoft.Azure.Management.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateSharedImageDistributor : ImageTemplateDistributor
    {
        ...
        /// distributor.</param>
        public ImageTemplateSharedImageDistributor(string runOutputName, string galleryImageId, IList<string> replicationRegions, IDictionary<string, string> artifactTags = default(IDictionary<string, string>))
